...
Date: 2026-09-19. Status: **approved by the owner on 2026-09-19 (*"Go with your recommendations for all of them except I think buildings should block light"*). Nothing is implemented.** This document owns the darkness, light and light-avoidance rules for the Unity port, and the documents listed in §9 point here. Decision: **U-D-58**. Tasks: L-01, L-02, L-03 and L-ACC in `TASKS.md`.
