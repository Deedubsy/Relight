// REL-58 look: re-arm the once-only blind-turret guide line (assistant session only), hold the staged alien at its dark spot, mark turret 2 hit now, and queue a capture for this frame.
