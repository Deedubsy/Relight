...
string log="E:/Factorio2/Unity/Docs/evidence/ux-pass/final-layout-log.txt";
...
Check(UnityEngine.Object.FindObjectsByType<UnityEngine.UIElements.UIDocument>().First(d=>d.visualTreeAsset!=null&&d.visualTreeAsset.name=="GameUI").panelSettings.scale==1.25f,"Settings applies actual 125 percent panel scale");UnityEngine.ScreenCapture.CaptureScreenshot("E:/Factorio2/Unity/Docs/evidence/ux-pass/final-settings-720-scale125.png");yield return null;yield return Click(P("settings-back"));yield return Click(P("pause-save"));((UnityEngine.UIElements.TextField)P("save-name")).value="UI inspection 123";
UnityEngine.ScreenCapture.CaptureScreenshot("E:/Factorio2/Unity/Docs/evidence/ux-pass/final-save-720-scale125.png");yield return null;yield return Click(P("save-back"));yield return Click(P("pause-resume"));
...
UnityEngine.ScreenCapture.CaptureScreenshot("E:/Factorio2/Unity/Docs/evidence/ux-pass/final-workshop-720-scale125.png");yield return null;
...
yield return Click(Q("jump-workshop"));UnityEngine.ScreenCapture.CaptureScreenshot("E:/Factorio2/Unity/Docs/evidence/ux-pass/final-inventory-720-scale125.png");yield return null;
...
var target=Q("hud-slot-9");using(var e=UnityEngine.UIElements.PointerEnterEvent.GetPooled()){e.target=target;target.SendEvent(e);}yield return new UnityEngine.WaitForSecondsRealtime(.4f);UnityEngine.ScreenCapture.CaptureScreenshot("E:/Factorio2/Unity/Docs/evidence/ux-pass/final-tooltip-720-scale125.png");yield return null;
