...
var doc0=UnityEngine.Object.FindObjectsByType<UnityEngine.UIElements.UIDocument>().First(d=>d.visualTreeAsset!=null&&d.visualTreeAsset.name=="GameUI");doc0.panelSettings.scale=1;
var game0=UnityEditor.EditorWindow.GetWindow(typeof(UnityEditor.Editor).Assembly.GetType("UnityEditor.GameView"));game0.GetType().GetProperty("selectedSizeIndex",System.Reflection.BindingFlags.Instance|System.Reflection.BindingFlags.Public|System.Reflection.BindingFlags.NonPublic).SetValue(game0,3);
yield return new UnityEngine.WaitForSecondsRealtime(.3f);yield return Tap(UnityEngine.InputSystem.Key.Tab);yield return Click(Q("jump-workshop"));yield return new UnityEngine.WaitForSecondsRealtime(.3f);
