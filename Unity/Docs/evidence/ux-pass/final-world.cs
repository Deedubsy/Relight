...
string log="E:/Factorio2/Unity/Docs/evidence/ux-pass/final-world-log.txt";
...
yield return new UnityEngine.WaitForSecondsRealtime(.4f);UnityEngine.ScreenCapture.CaptureScreenshot("E:/Factorio2/Unity/Docs/evidence/ux-pass/final-hud-1080.png");yield return null;yield return null;
...
Check(sim.State.Engineer.Mining && sim.State.Engineer.MineProg>0,"Final mining card uses running simulation progress");UnityEngine.ScreenCapture.CaptureScreenshot("E:/Factorio2/Unity/Docs/evidence/ux-pass/final-mining-1080.png");yield return new UnityEngine.WaitForSecondsRealtime(2f);
...
yield return Tap(UnityEngine.InputSystem.Key.Tab);yield return new UnityEngine.WaitForSecondsRealtime(.3f);UnityEngine.ScreenCapture.CaptureScreenshot("E:/Factorio2/Unity/Docs/evidence/ux-pass/final-inventory-1080.png");yield return null;
