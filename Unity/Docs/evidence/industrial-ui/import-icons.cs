...
var names=new[]{"steel","copper","coal","bullet","rifle","generator","excavator","chest","belt","pole","assembler","turret","lamp"};
...
so.ApplyModifiedPropertiesWithoutUndo();library.Invalidate();UnityEditor.EditorUtility.SetDirty(library);UnityEditor.AssetDatabase.SaveAssets();return "13 painted icons bound; existing remaining entries preserved";
