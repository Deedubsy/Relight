...
prior=json.loads((root/'docs/evidence/p9-01-2026-09-08/manifest.json').read_text(encoding='utf-8'))
files=list(prior['source_files'])+['packages/sim/test/campaignSurvey.test.ts']
