...
for(const turn of [0,1,2,3])for(const lane of [0,1]){
 ...
 const raw:[string,Kind,number,number,Dir][]=[['source','chest',0,0,1],['arm','inserter',2,lane,1],['belt','belt',3,lane,1],['turret','turret',4,0,0]];
...
console.log('PASS: 8 turret perimeter tiles load directly from a conveyor, back up at 50 rounds, resume for an empty replacement, conserve and save/replay.');
