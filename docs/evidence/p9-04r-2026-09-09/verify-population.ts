...
const out='docs/evidence/p9-04r-2026-09-09/population',m=JSON.parse(readFileSync(out+'/manifest.json','utf8')),rows=readPopulationRows(out,m),summary=JSON.parse(readFileSync(out+'/summary.json','utf8'));
