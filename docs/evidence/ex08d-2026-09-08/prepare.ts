...
const out='docs/evidence/ex08d-2026-09-08',ref={kind:'campaign',ruleset:'exploration-v2',opening:'culdesac-v1'} as const,provenance=stamp(ref);
const evidence=JSON.parse(readFileSync('docs/evidence/p7-05-2026-09-08/campaign/E-defence-turrets-seed3.json','utf8'));
const initial=createCampaign(3);
...
const settings={...provenance,session:'EX-08H-D / P6-H / P7-H / P8-H / T18',human_play:'not_run',starts,defaultStart:'fresh',speed:'1x; pauses/interventions recorded',difficulty:'unchanged default campaign rules',config:initial.config,clock:CAMPAIGN_RULES,threat:CAMPAIGN_THREAT,defence:DEFENCE,districts:DISTRICT_ECONOMY,discovery:DISCOVERY};
