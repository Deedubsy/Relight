...
**Now (2026-09-06):** Phase 4 complete (owner, D-EX-10). EX-01/02 and freight EX-06A are complete. D-EX-13 authorises campaign separation and the home opening. EX-03 and EX-04A are complete; EX-04 continues with the second-area station and radio opportunity. The new home preview is explicitly selected and keeps legacy saves and benchmarks separate.
...
| EX-04 | Cul-de-sac, factory start, second-area tram access and radio restoration opportunity | agent | in_progress | EX-03 done; D-EX-Q01–06 decided | One early hostile approach; reachable resources; useful reward; real costs and placements; no tram unlock circularity | docs/CAMPAIGN_OPENING_REPORT.md (home subset only; station/radio pending) | |
