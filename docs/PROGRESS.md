...
**Now (2026-09-06):** Phase 4 complete (owner, D-EX-10). EX-01 baseline comparison and EX-02 contracts are complete. The owner authorised integration and tram work (D-EX-12); newer main is merged with the adopted documentation preserved. EX-06A is the independently testable first freight increment; EX-03 still owns full campaign/evidence profile separation before the revised opening.

The Version 2 plan is EXPLORATION_DEFENCE_PLAN.md. The EX rows below are the current execution order. The earlier rows remain historical/reuse records in their original order. Every unfinished legacy row now depends on EX-09, where its acceptance must be rewritten, absorbed with explicit mapping, or referred to the owner; this is not permission to execute its obsolete text unchanged once EX-09 finishes. Completed and waived rows retain their evidence.
...
| EX-03 | Version 2 implementation/evidence profiles and save compatibility | agent | in_progress | EX-01 done; EX-02 done; integration authorised D-EX-12 | Integrated baseline; legacy/new campaign rules and tooling separated before new constants; save/replay compatibility checked | docs/TRAM_INTEGRATION_REPORT.md (freight schema subset); full profile routing pending | |
| EX-04 | Cul-de-sac, factory start, second-area tram access and radio restoration opportunity | agent | blocked | EX-03; D-EX-Q01–06 | One early hostile approach; reachable resources; useful reward; real costs and placements; no tram unlock circularity | pending — EX-04 evidence | |
| EX-05 | Site creatures, shared minor raids, major schedule and radio warning | agent | blocked | EX-04; D-EX-Q01/02/03/06 | One major target; rest days survive restorations/load; bounded raids; valid paths; actual defence/repair support and useful truthful warnings | pending — EX-05 evidence | |
| EX-06 | Multi-stop freight, specialised factories and useful workshop | agent | blocked | EX-04; D-EX-Q01/04/05/06 | Selective freight and onward supply; return goods; conserved items; interruption recovery; old factory contributes later | pending — EX-06 evidence | |
