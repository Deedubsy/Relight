...
"Whole plan", D-RI-1) is the task order. RI-00 through RI-06 are implemented; **RI-02A is complete; RI-06 validation is repaired. RI-07 is next.** T12 and T12a are absorbed (their scope is RI-01 / RI-03 and RI-02, recorded once
...
| RI-02A | **City Structure and Visual Identity**: bounded city pass authorised 2026-09-05; retain completed RI-02 through RI-06; no new encounters or expedition system | codex | done | RI-02 (done) | normal new-game profile; shared render/collision geometry; construction, navigation, ownership and seed checks; inspected screenshots | `docs/CITY_REBUILD_REPORT.md` | 2026-09-06 |
| CITY-01 | Active-path diagnosis and baseline captures | codex | done | RI-02 | actual opening / construction / overview captured | `docs/CITY_REBUILD_REPORT.md` | 2026-09-06 |
| CITY-02 | Opening composition and street hierarchy | codex | done | CITY-01 | connected routes, working yards and rail reservations | `docs/CITY_REBUILD_REPORT.md` | 2026-09-06 |
| CITY-03 | Urban structures and district visual kit | codex | done | CITY-02 | coherent actual in-game silhouettes and entrances | `docs/CITY_REBUILD_REPORT.md` | 2026-09-06 |
| CITY-04 | Restoration, camera and wayfinding | codex | done | CITY-03 | matched street states and useful engineer scale | `docs/CITY_REBUILD_REPORT.md` | 2026-09-06 |
| CITY-05 | Profile integration and compatibility | codex | done | CITY-02 | reproducible seeds, saves, footprints, routes and ownership checked | `docs/CITY_REBUILD_REPORT.md` | 2026-09-06 |
| CITY-06 | Screenshot inspection, refinement and handoff | codex | done | CITY-04, CITY-05 | screenshots inspected, findings corrected, verification recorded | `docs/CITY_REBUILD_REPORT.md` | 2026-09-06 |
| RI-03 | **Physical commissioning and field deployment** (plan §4; T13's placement piece; D-CU-1, D-CU-3, D-P4-9's other half): one claim path — map selection previews and charges nothing; power connection, materials delivered to the installation and an explicit Activate within reach; paid once; the field kit (poles, unlocked lights, turrets, belts, inserters, chests, the outskirts Substation) placeable on Dark / Contested blocks adjacent to Held, drawing real power from the connected grid; one commissioning event per activation (no double bloom); the outskirts Substation before activation; replay and save consistency; the hour bot on the physical path | claude | done | RI-01; adopted geometry compatibility: RI-02A | a transition test covers double activation, invalid prerequisites, missing power and charging once; `E-hour` green on seeds 3 / 4 / 5 with every claim made by the physical path, reported beside the legacy run; no infinite-power flag; a field device never marks a block Held; `snapshot:check` unchanged or the change reported as a rules change | `docs/RI_PASS_1_REPORT.md` "RI-03" | 2026-09-05 |
...
- 2026-09-06 — RI-02A and CITY-01 through CITY-06 done: normal riverside-v1 city, shared structural masks, inspected browser captures and compatibility evidence in `CITY_REBUILD_REPORT.md`. Existing RI-06 failures reproduced; no human task signed and no next phase implemented.

- 2026-09-06 — RI-06 reopened for the authorised Heart validation fixes; baseline reproduced in docs/evidence/heart-fix/baseline.log.

- 2026-09-06 — RI-06 validation repairs complete: cabinet project state, real preparation and patrol stock, ammunition handoff, event/replay and save-test fixes; 6/6 Heart tests and all 15 experiments pass. Windows archive freshness and test-worker isolation repaired; RI-07 is next. Evidence: RI_PASS_1_REPORT.md, RI-06 validation fixes.
