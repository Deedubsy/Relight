...
**Task list: `docs/PROGRESS.md` (T10–T18).** **Status: open, nothing built. T10 done 2026-09-05 (the opening, `PHASE_5_REPORT.md`); T11 — the human's seven rows — is the next task and blocks T12–T17.** Branch `phase-4` for the opening (doc only, PR #5); the first build milestone opens `phase-5` as PR #6. Report `docs/PHASE_5_REPORT.md`.
