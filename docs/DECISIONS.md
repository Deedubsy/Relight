...
| C10 | Start ammo | 20 magazines (§11) | sim `startRounds` 300 = 30 magazines | Phase 1: E1-start-min — the HQ never falls on 200 rounds (20 magazines) with the ammo line from minute 10 under the 40-arrival rule (32 accrue); a 10- or 20-arrival rule loses it at minute 8 (E1-ring-substation-N10/N20) | Reconcile in the Phase 1 doc pass; which is it? | **made 2026-09-03 (D-P1-3 rider): 20 magazines.** Sim `startRounds` 200; §11 states the margin; part of config hash `01dc5d02` |
