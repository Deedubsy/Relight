 ...
 *  "30 to 60") stays prose; this table is the rule. The last row sits past the hour on purpose: D-P4-10 (a) puts
 *  north's claim at 60–75, so hour one is two claims and the hour ends with three blocks Held. */
...
export const HOUR: readonly HourStep[] = [
  ...
  { id: 'claim-north', min: 65, what: 'claim north (civic) — after the hour, once west\'s coal is real', doc: 'D-HOUR-1, D-B6-2, D-P4-10' },
];
