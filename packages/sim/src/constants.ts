 ...
 *  "30 to 75") stays prose; this table is the rule. The last row is inside the hour: D-P4-10 (a) puts north's claim
 *  at 60–75 and D-HOUR-3 (a) re-scopes "hour one" to HOUR_MINUTES (75 minutes), so hour one is three claims and the
 *  hour ends with four blocks Held (built by RI-01, 2026-09-05; before it a 60-minute run stopped short of north). */
/** D-HOUR-3 (a), decided 2026-09-05: the opening "hour" the hour bot, E-hour and the §11 minute table cover is 75
 *  minutes — long enough for north's claim (HOUR's last row) to be inside the scored run. Built by RI-01. */
export const HOUR_MINUTES = 75;
...
export const HOUR: readonly HourStep[] = [
  ...
  { id: 'steel-2', min: 12, what: 'the second steel Excavator, belted into the chest', doc: 'D-P4-7, D-HOUR-1, D-HOUR-2' },
  ...
  { id: 'claim-north', min: 65, what: 'claim north (civic), once west\'s coal is real (the rail-yard line)', doc: 'D-HOUR-1, D-B6-2, D-P4-10, D-HOUR-3' },
];
