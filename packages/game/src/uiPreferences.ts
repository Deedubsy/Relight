...
export const DEFAULT_QUICKBAR:readonly (QuickTool|null)[]=['belt','inserter','excavator',null,null,null,null,null,null,null];
...
export function parseUiPreferences(raw:string|null):UiPreferences {
 ...
 try{const v=JSON.parse(raw??'null');if(v?.version!==1)return base;
  if(Array.isArray(v.quickbar)&&v.quickbar.length===10)base.quickbar=v.quickbar.map((k:unknown)=>k==='rifle'||(CAMPAIGN_KINDS.includes(k as Kind)&&k!=='depot')?k:null);
